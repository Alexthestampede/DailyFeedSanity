"""
Vision processing with Google Gemini for RSS Feed Processor

This module provides image analysis using Google's Gemini vision capabilities.
"""
import base64
import requests
...
from ..config import GEMINI_VISION_MODEL, VISION_TEMPERATURE
...
class GeminiVisionClient:
    """
    Vision processor using Google Gemini for image analysis.

    Gemini 1.5 Flash and Pro models have built-in vision capabilities.
    """

    def __init__(self, api_key: str, model: str = GEMINI_VISION_MODEL):
        """
